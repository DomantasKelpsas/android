...
public class InsertActivity extends Activity  {
    ...
    {
        new detiUzrasa().execute(Tools.InsertURL, null, null);

    }

    public class detiUzrasa extends AsyncTask<String, Void, List<Uzrasas>>
    {
        ProgressDialog actionProgressDialog = new ProgressDialog(InsertActivity.this);
        ...
        protected void onPostExecute(List<Uzrasas> result) {
            ...
            Toast.makeText(InsertActivity.this, "Uzrasas iterptas", Toast.LENGTH_SHORT).show();
